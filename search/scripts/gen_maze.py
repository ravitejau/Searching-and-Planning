...
def copy_empty_world():
    f_in = open('/home/ravi_upmaka/catkin_ws/src/search/worlds/empty_world.sdf', 'r')
    f_out = open('/home/ravi_upmaka/catkin_ws/src/search/worlds/maze.sdf', 'w')
    for line in f_in:
        f_out.write(line)
    f_in.close()
    return f_out
...
def generate_blocked_edges(grid_dimension, n_obstacles, seed, myscale=0.5):
	...
	add_goal(f_out, grid_dimension*0.25)
	f_out.write('</state>')
	#add_goal_description(f_out, grid_dimension*0.5)
	add_goal_description(f_out, grid_dimension*0.25)
